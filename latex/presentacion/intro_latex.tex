...
\begin{tikzpicture}[remember picture, overlay,
  ...
  \node [right = 1.6cm of b]  (B) {Preámbulo};
  \node [right = 4.7cm of c]  (C) {Inicio entorno documento};
  \node [right = 5.2cm of d]  (D) {Contenidos del documento};  
  \node [right = 5.2cm of e]  (E) {Fin entorno documento};  
...
\begin{frame}[t]\frametitle{Quiero Usar \LaTeX. ¿Cómo empezar?}
	\begin{itemize}
		\item Documentación:
		\begin{itemize}
